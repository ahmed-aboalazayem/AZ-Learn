    ...
    return (
        <div className="p-8 max-w-container_max_width mx-auto flex flex-col gap-8 w-full font-['Plus_Jakarta_Sans']">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                ...
                <div className="flex bg-surface-container-highest p-1 rounded-lg select-none">
                    <button
                        ...
                        className={`px-6 py-2 rounded-md text-sm font-semibold transition-all cursor-pointer border-none ${timeframe === "weekly"
                    ...
                    <button
                        ...
                        className={`px-6 py-2 rounded-md text-sm font-semibold transition-all cursor-pointer border-none ${timeframe === "all-time"
                            ? "bg-white text-primary shadow-sm"
                            : "text-on-surface-variant hover:text-on-surface bg-transparent"
                            }`}
                    >
            ...
            <div className="relative mt-4">
                {/* Overlay */}
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-surface/30 backdrop-blur-[4px] rounded-2xl">
                    <div className="bg-surface-container-lowest p-8 rounded-2xl shadow-2xl flex flex-col items-center text-center max-w-md border border-outline-variant">
                        <div className="w-16 h-16 bg-gradient-to-br from-amber-400 to-amber-600 text-white rounded-full flex items-center justify-center mb-6 shadow-md shadow-amber-500/30">
                            <span style={{ color: "#000" }} className="material-symbols-outlined text-[32px]">lock</span>
                        </div>
                        <h2 className="font-h2 text-2xl font-bold text-on-surface mb-3">Leaderboard Locked</h2>
                        <p className="text-on-surface-variant font-body-md mb-8">
                            Upgrade to our Pro plan to see how you rank among other learners, earn badges, and unlock advanced gamified features.
                        </p>
                        <button style={{ color: "#000" }} className="px-8 py-3.5 bg-gradient-to-r from-primary to-primary-fixed-variant text-white rounded-full font-bold hover:shadow-lg hover:-translate-y-0.5 transition-all shadow-md cursor-pointer border-none">
                            Subscribe to Activate
                        </button>
                    </div>
                </div>

                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 blur-[6px] select-none pointer-events-none opacity-70">
