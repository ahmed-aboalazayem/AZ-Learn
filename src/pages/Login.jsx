...
export default function Login() {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden bg-surface-container font-body-md text-body-md text-on-surface">
            ...
            {/* Auth Card */}
            <main className="w-full max-w-[440px] bg-surface-container-lowest rounded-[16px] soft-elevation p-8 relative z-10 flex flex-col gap-8">
                {/* Header */}
                <div className="flex flex-col items-center text-center gap-2">
                    ...
                    <h1 className="font-h2 text-h2 text-on-surface">AZ Learn</h1>
                    <p className="font-body-md text-body-md text-on-surface-variant">From A to Z</p>
                </div>
                ...
                <div className="text-center mt-2">
                    <p className="font-body-md text-body-md text-on-surface-variant">
                        ...
                        <Link className="font-label-md text-label-md text-primary hover:text-primary-fixed-variant transition-colors ml-1 no-underline font-semibold" to="/register">Sign up</Link>
                    </p>
                </div>
            </main>
        </div>
